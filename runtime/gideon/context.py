    ...
    def build_message(
        ...
        if is_new_session:
            ...
            if resumed and session_key:
                from gideon.resume_account import NOT_CONSULTED, resume_account_block
        ...
        # `gideon.learning`, whose package __init__ pulls the whole learning graph —
        # a cost every `import gideon.context` would otherwise pay. Same reason the
        # ablation import at :214 is local.
        from gideon.skills.allocation import FORCED_SCORE, SkillRequest, allocate_skills
