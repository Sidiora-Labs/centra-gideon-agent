...
1. **Strictly read-only.** Resolving opens the declared file, parses it, and returns. It
   ...
   not-signed-in and the user re-runs their own CLI's login; Gideon does not touch
...
class SubscriptionSource:
    ...
    ``id`` is what a :class:`~gideon.sdk.provider_helpers.BrandedProviderSpec` names
