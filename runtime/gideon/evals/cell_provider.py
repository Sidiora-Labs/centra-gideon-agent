...
:func:`apply_in_child` goes through :func:`gideon.evals.overlay.throwaway_home`,
...
def resolve_binding(model_ref: str, *, use_case: str = "chat") -> CellProviderBinding:
    ...
    :class:`~gideon.llm.branded_specs.BrandedProviderSpec` (for the wire protocol,
    ...
    """
    from gideon.llm.branded_specs import registered_spec
...
def _spec_for(binding: CellProviderBinding):
    ...
    from gideon.llm.branded_specs import BrandedProviderSpec
...
def _register_cell_type(binding: CellProviderBinding) -> str:
    ...
    """
    from gideon.llm.branded_specs import build_protocol_provider
    from gideon.llm.capabilities import ProviderCapability
