...
:mod:`gideon.automation.trigger_sources.base` is the contract an app implements (re-exported for apps
via ``gideon.sdk.trigger_source``); :mod:`gideon.automation.trigger_sources.registry` is the flat
