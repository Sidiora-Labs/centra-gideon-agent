...
DISPOSITION: tuple[Row, ...] = (
    Row(
        ...
        module="gideon.automation.schedule",
    ...
    Row(
        surface="schedule_history.py ExecutionRecord",
        module="gideon.automation.schedule_history",
        verdict=Verdict.ABSORBED,
        keeps=(
    ...
    Row(
        ...
        module="gideon.automation.event_triggers",
        verdict=Verdict.ABSORBED,
    ...
    Row(
        ...
        module="gideon.automation.triggers.nudge",
        verdict=Verdict.ABSORBED,
        keeps=(
            "reactive re-arm",
    ...
    Row(
        ...
        module="gideon.engine.heartbeat",
        verdict=Verdict.ABSORBED,
    ...
    Row(
        ...
        module="gideon.integrations.inbox",
    ...
    Row(
        surface="fs_watch.py",
        module="gideon.automation.fs_watch",
        verdict=Verdict.KEPT_WITH_DUTY,
    ...
    Row(
        ...
        module="gideon.cognition.after_turn_review",
        verdict=Verdict.KEPT,
    ...
    Row(
        ...
        module="gideon.cognition.suggestions",
        verdict=Verdict.KEPT,
        note="Read-time computation. The counter-example stays the counter-example.",
    ),
    Row(
        surface="engagement_signals.py",
        module="gideon.cognition.engagement_signals",
        verdict=Verdict.KEPT,
    ),
    Row(
        surface="/api/triggers facade",
        module="gideon.interfaces.dashboard.handlers.triggers",
        verdict=Verdict.KEPT,
    ...
    Row(
        surface="App crons",
        module="gideon.extensions.apps.app_crons",
        verdict=Verdict.ABSORBED,
        keeps=(
