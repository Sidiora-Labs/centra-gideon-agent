...
class DiscoveryResult:
    ...
    ``configOptions.effort``), surfaced VERBATIM as ``{value, label}`` — Gideon does
...
class ACPDialect:
    ...
    def set_effort_request(self, *, session_id: str, effort: str) -> AcpRequest | None:
        ...
        :attr:`DiscoveryResult.supported_efforts`) — no Gideon translation. The
...
class ZedAdapterDialect(ACPDialect):
    ...
    def set_effort_request(self, *, session_id: str, effort: str) -> AcpRequest | None:
        ...
        option (surfaced verbatim as supported_efforts) — no Gideon translation.
