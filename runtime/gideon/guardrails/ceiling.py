...
running agent does not own. Level 2 is the existing :class:`~gideon.guardrails.
...
:mod:`gideon.guardrails.registries` and are never sourced from the governed file;
...
#: Directory (under the Gideon home) that holds the ceiling. Also registered in
