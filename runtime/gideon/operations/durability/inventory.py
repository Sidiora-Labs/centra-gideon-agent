...
INVENTORY: tuple[StateEntry, ...] = (
    ...
    StateEntry(id="capability_peer_identity", kind=KIND_TREE, path="capabilities/platform/identity.key", domain=DOMAIN_SECURITY, merge=MERGE_REPLACE_ONLY, secret=True),
    StateEntry(id="capability_peer_policy", kind=KIND_SQLITE, path="capabilities/platform/peers.sqlite3", domain=DOMAIN_SECURITY, merge=MERGE_REPLACE_ONLY, secret=True),
