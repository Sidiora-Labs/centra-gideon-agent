...
INVENTORY: tuple[StateEntry, ...] = (
    StateEntry(
        id="capability_experience_moltbook",
        kind=KIND_SQLITE,
        path="capabilities/experience/moltbook.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_creative_direction",
        kind=KIND_SQLITE,
        path="capabilities/creative/direction.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_platform_integrations",
        kind=KIND_SQLITE,
        path="capabilities/platform/integration_apps.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_platform_remote_sessions",
        kind=KIND_SQLITE,
        path="capabilities/platform/remote-agent-sessions.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_platform_migration_journals",
        kind=KIND_TREE,
        path="capabilities/platform/migration-journals",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_platform_quotas",
        kind=KIND_SQLITE,
        path="capabilities/platform_quotas.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_platform_replication",
        kind=KIND_SQLITE,
        path="capabilities/platform/replication.sqlite3",
        domain=DOMAIN_SECURITY,
        merge=MERGE_REPLACE_ONLY,
        secret=True,
    ),
    StateEntry(
        id="capability_creative_peer_feedback",
        kind=KIND_SQLITE,
        path="capabilities/creative/peer_feedback.sqlite3",
        domain=DOMAIN_SECURITY,
        merge=MERGE_REPLACE_ONLY,
        secret=True,
    ),
    StateEntry(
        id="capability_platform_media_shares",
        kind=KIND_SQLITE,
        path="capabilities/platform/media_shares.sqlite3",
        domain=DOMAIN_SECURITY,
        merge=MERGE_REPLACE_ONLY,
        secret=True,
    ),
    StateEntry(
        id="capability_creative_export_records",
        kind=KIND_SQLITE,
        path="capabilities/creative/exports.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_creative_export_assets",
        kind=KIND_TREE,
        path="capabilities/creative/exports",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_knowledge_video_assets",
        kind=KIND_TREE,
        path="capabilities/knowledge/videos",
        domain=DOMAIN_KNOWLEDGE,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_media_sprites",
        kind=KIND_SQLITE,
        path="capabilities/media/sprites.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_inference_host",
        kind=KIND_JSON_FILE,
        path="capabilities/platform/inference_host.json",
        domain=DOMAIN_CONFIG,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_peer_identity",
        kind=KIND_TREE,
        path="capabilities/platform/identity.key",
        domain=DOMAIN_SECURITY,
        merge=MERGE_REPLACE_ONLY,
        secret=True,
    ),
    StateEntry(
        id="capability_peer_policy",
        kind=KIND_SQLITE,
        path="capabilities/platform/peers.sqlite3",
        domain=DOMAIN_SECURITY,
        merge=MERGE_REPLACE_ONLY,
        secret=True,
    ),
    StateEntry(
        id="capability_wellbeing_shared",
        kind=KIND_JSON_FILE,
        path="shared/wellbeing.json",
        domain=DOMAIN_KNOWLEDGE,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_privacy",
        kind=KIND_SQLITE,
        path="capabilities/privacy.sqlite3",
        domain=DOMAIN_SECURITY,
        merge=MERGE_REPLACE_ONLY,
        secret=True,
    ),
    StateEntry(
        id="capability_workspace_native_paired_devices",
        kind=KIND_SQLITE,
        path="capabilities/workspace/native/paired-devices.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_music_decks",
        kind=KIND_SQLITE,
        path="capabilities/music/decks.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_media_episodes",
        kind=KIND_SQLITE,
        path="capabilities/media/episodes.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_media_timelines",
        kind=KIND_SQLITE,
        path="capabilities/media/timelines.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_music_spotify",
        kind=KIND_SQLITE,
        path="capabilities/music/spotify.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_music_listening",
        kind=KIND_SQLITE,
        path="capabilities/music/listening.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_identity_lifecycle",
        kind=KIND_SQLITE,
        path="capabilities/identity/lifecycle.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_models_loras",
        kind=KIND_TREE,
        path="models/loras",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ...
    StateEntry(
        id="capability_models_lora_training",
        kind=KIND_TREE,
        path="models/lora-training",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_platform_cadence",
        kind=KIND_JSON_FILE,
        path="capabilities/platform/cadence.json",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_platform_pr_screening",
        kind=KIND_TREE,
        path="capabilities/platform/pr_screening",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_platform_maintenance",
        kind=KIND_TREE,
        path="capabilities/platform/maintenance",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_workspace_desktops_project_operations",
        kind=KIND_SQLITE,
        path="capabilities/workspace/desktops/project-operations.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_workspace_desktops_desktop_sessions",
        kind=KIND_SQLITE,
        path="capabilities/workspace/desktops/desktop-sessions.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_media_datasets",
        kind=KIND_SQLITE,
        path="capabilities/media/datasets.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_music_assemblies",
        kind=KIND_SQLITE,
        path="capabilities/music/assemblies.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_music_image3d",
        kind=KIND_SQLITE,
        path="capabilities/music/image3d.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_identity_bundles",
        kind=KIND_SQLITE,
        path="capabilities/identity/bundles.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_identity_recipes",
        kind=KIND_SQLITE,
        path="capabilities/identity/recipes.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_music_music_video",
        kind=KIND_SQLITE,
        path="capabilities/music/music_video.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_identity_continuity",
        kind=KIND_SQLITE,
        path="capabilities/identity/continuity.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_workspace_git_git_operations",
        kind=KIND_SQLITE,
        path="capabilities/workspace/git/git-operations.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_workspace_git_project_operations",
        kind=KIND_SQLITE,
        path="capabilities/workspace/git/project-operations.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_music_midi",
        kind=KIND_SQLITE,
        path="capabilities/music/midi.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_workspace_projects_project_operations",
        kind=KIND_SQLITE,
        path="capabilities/workspace/projects/project-operations.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_identity_goals",
        kind=KIND_SQLITE,
        path="capabilities/identity/goals.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_identity_progress",
        kind=KIND_SQLITE,
        path="capabilities/identity/progress.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_music_rounds",
        kind=KIND_SQLITE,
        path="capabilities/music/rounds.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_platform_feature_ownership",
        kind=KIND_SQLITE,
        path="capabilities/platform/feature_ownership.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_media_readiness",
        kind=KIND_SQLITE,
        path="capabilities/media/readiness.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
    ),
    StateEntry(
        id="capability_workspace_processes_processes",
        kind=KIND_SQLITE,
        path="capabilities/workspace/processes/processes.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
        help="Capability records and immutable revision history",
    ),
    StateEntry(
        id="capability_workspace_ports_ports",
        kind=KIND_SQLITE,
        path="capabilities/workspace/ports/ports.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
        help="Capability records and immutable revision history",
    ),
    StateEntry(
        id="capability_identity_fidelity",
        kind=KIND_SQLITE,
        path="capabilities/identity/fidelity.sqlite3",
        domain=DOMAIN_MEMORY,
        merge=MERGE_REPLACE_ONLY,
        help="Capability records and immutable revision history",
    ),
    StateEntry(
        id="capability_music_generation",
        kind=KIND_SQLITE,
        path="capabilities/music/generation.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
        help="Capability records and immutable revision history",
    ),
    StateEntry(
        id="capability_media_annotations",
        kind=KIND_SQLITE,
        path="capabilities/media/annotations.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
        help="Capability records and immutable revision history",
    ),
    StateEntry(
        id="capability_media_jobs",
        kind=KIND_SQLITE,
        path="capabilities/media/jobs.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
        help="Capability records and immutable revision history",
    ),
    StateEntry(
        id="capability_platform_reviews",
        kind=KIND_SQLITE,
        path="capabilities/platform/reviews.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
        help="Capability records and immutable revision history",
    ),
    StateEntry(
        id="capability_mailbox_sources",
        kind=KIND_TREE,
        path="capabilities/communications/mailboxes",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
        help="Imported mailbox source files",
    ),
    StateEntry(
        id="capability_workspace_snapshots",
        kind=KIND_SQLITE,
        path="capabilities/workspace/snapshots.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
        help="Capability records and immutable revision history",
    ),
    StateEntry(
        id="capability_identity_stories",
        kind=KIND_SQLITE,
        path="capabilities/identity/stories.sqlite3",
        domain=DOMAIN_MEMORY,
        merge=MERGE_REPLACE_ONLY,
        help="Capability records and immutable revision history",
    ),
    StateEntry(
        id="capability_identity_twin",
        kind=KIND_SQLITE,
        path="capabilities/identity/twin.sqlite3",
        domain=DOMAIN_MEMORY,
        merge=MERGE_REPLACE_ONLY,
        help="Capability records and immutable revision history",
    ),
    StateEntry(
        id="capability_wellbeing",
        kind=KIND_SQLITE,
        path="capabilities/wellbeing.sqlite3",
        domain=DOMAIN_KNOWLEDGE,
        merge=MERGE_REPLACE_ONLY,
        help="Capability records and immutable revision history",
    ),
    StateEntry(
        id="capability_communications_people",
        kind=KIND_SQLITE,
        path="capabilities/communications/people.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
        help="Capability records and immutable revision history",
    ),
    StateEntry(
        id="capability_media_sketches",
        kind=KIND_SQLITE,
        path="capabilities/media/sketches.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
        help="Capability records and immutable revision history",
    ),
    StateEntry(
        id="capability_creative_catalog",
        kind=KIND_SQLITE,
        path="capabilities/creative/catalog.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
        help="Capability records and immutable revision history",
    ),
    StateEntry(
        id="capability_music_repertoire",
        kind=KIND_SQLITE,
        path="capabilities/music/repertoire.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
        help="Capability records and immutable revision history",
    ),
    StateEntry(
        id="capability_music_music_catalog",
        kind=KIND_SQLITE,
        path="capabilities/music/music_catalog.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
        help="Capability records and immutable revision history",
    ),
    StateEntry(
        ...
        kind=KIND_SQLITE,
        path="capabilities/experience.sqlite3",
        domain=DOMAIN_WORK,
        merge=MERGE_REPLACE_ONLY,
        help="Capability records and immutable revision history",
    ),
