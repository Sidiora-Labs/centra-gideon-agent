...
INVENTORY: tuple[StateEntry, ...] = (
    ...
    StateEntry(
        id="usage_summary",
        kind=KIND_JSON_FILE,
        path="usage_stats.json",
        domain=DOMAIN_PLATFORM,
        merge=MERGE_REPLACE_ONLY,
        derived=True,
        help="daily usage/spend fold, refolded from model_calls.jsonl + usage/turns.jsonl",
    ),
    StateEntry(
    ...
    StateEntry(
        id="release_cache",
        kind=KIND_JSON_FILE,
        path="update_check.json",
        domain=DOMAIN_PLATFORM,
        merge=MERGE_REPLACE_ONLY,
        derived=True,
        help="latest-release view (re-fetched by the update check)",
    ),
    StateEntry(
        id="release_catalog_cache",
        kind=KIND_JSON_FILE,
        path="update_releases.json",
        domain=DOMAIN_PLATFORM,
        merge=MERGE_REPLACE_ONLY,
        derived=True,
        help="cached release history the channel/pin resolver reads (re-fetched)",
    ),
    StateEntry(
        id="durability_state",
        kind=KIND_JSON_FILE,
