...
def run_sync_cycle(
    ...
    *,
    ...
    codec = None
    try:
        from gideon.operations.durability.crypto import SyncEncryptionError, codec_for
    ...
    try:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            report.seq_published = (
                report.pushed.seq if report.pushed.registry_committed else 0
            )
