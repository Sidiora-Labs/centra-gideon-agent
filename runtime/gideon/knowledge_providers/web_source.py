...
from gideon.knowledge_providers.html_dom import (
    Element,
    SelectorError,
    parse_html,
    parse_selector,
...
def sanitize_markup(html: str) -> str:
    ...
    from gideon.web.extract import sanitize_html as _sanitize
...
class WebSourceProvider(KnowledgeSourceProvider):
    ...
    async def preview(
        ...
        :class:`~gideon.knowledge_providers.base.KnowledgeSourceProvider`: a feed's or a
