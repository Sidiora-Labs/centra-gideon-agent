...
declared :class:`~gideon.apps.manifest.PackSourceEntry`, validates the user's ``args``
...
to the script on stdin via :func:`~gideon.knowledge_providers.pack_parse.run_parse_script`.
...
:mod:`~gideon.knowledge_providers.conditional_get` helpers — the same ONE implementation
...
def render_fetch(
    ...
    *,
    ...
    """
    from gideon.apps.manifest import PACK_FETCH_METHODS, PACK_PLACEHOLDER_RE
