...
def run_media_worker():
    ...
    home = config_dir()
    sketches = SketchStore(home / 'capabilities/media/sketches.sqlite3', NativeArtifactProvider(home / 'artifacts'))
    return run_worker(MediaWorker(MediaJobs(home / 'capabilities/media/jobs.sqlite3', sketches)), context)
