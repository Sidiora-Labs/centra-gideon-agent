...
:meth:`gideon.skills.loader.SkillsLoader.load_skill`, the only place a skill body
...
by :func:`gideon.evals.overlay.apply_in_child` inside a throwaway eval child and
...
from gideon.evals.overlay import SUPPRESSED_SKILLS_ENV
