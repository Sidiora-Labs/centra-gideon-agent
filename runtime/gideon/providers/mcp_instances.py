...
``~/.gideon/mcp.json`` (loaded by :mod:`gideon.mcp_client` for the
native loop and merged into the agent config by :func:`gideon.agent.rebuild_agent_config`).
...
from gideon.providers.instances import ExtensionInstance
...
def _save(data: dict[str, Any]) -> None:
    from gideon.agent import _atomic_json_write  # circular import
