...
from gideon.net.policy import EgressPolicy, egress_policy_for
...
class GatedCdpSession:
    ...
    ``resolver`` is handed to :func:`gideon.net.guard.evaluate` (fake DNS in tests);
    ...
    async def start(self) -> None:
        ...
        try:
            from gideon.browse.safety_script import safety_script
    ...
    def _layered_policy(self) -> EgressPolicy:
        ...
        """
        from gideon.net.policy import BROWSE
