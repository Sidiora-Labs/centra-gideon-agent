...
:func:`~gideon.browse.plans.execute_tick` (BA-6 core) is kind-agnostic machinery: it
owns the idempotent cursor and the rung floor and calls an injected
:data:`~gideon.browse.plans.TickRunner` to actually touch the page. This module supplies
...
:class:`~gideon.browse.cdp.GatedCdpSession`, reads the settled DOM, and returns the
...
from gideon.browse.plans import (
    KIND_WATCH_PAGE,
    BrowsePlan,
    PlanError,
    TickOutcome,
