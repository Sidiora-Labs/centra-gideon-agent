...
def connector_status() -> ConnectorStatus:
    ...
    if session is None:
        return ConnectorStatus(
            ...
            fix=(
                "open your browser and connect the Gideon extension, " "then re-run this task"
            ),
        )
...
def unattended_origin() -> str:
    ...
    """
    try:
        from gideon.durability.state_history import current_surface, is_unattended_surface
