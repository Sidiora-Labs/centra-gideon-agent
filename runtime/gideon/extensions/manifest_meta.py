...
allowlist. This is the ONE hand-maintained input to :mod:`gideon.extensions.manifest`,
...
TOOL_META: dict[str, dict[str, Any]] = {
        ...
        "examples": [
            {
                ...
                "args": {"skill": "gideon-api", "path": "reference/api-notes.md"},
            },
        ],
    },
    "skill_search": {
    ...
    "artifact_list": {
        ...
        "error_codes": [],
        "examples": [
            {"summary": "List artifacts of a kind", "args": {"kind": "document"}}
        ],
    },
    "artifact_versions": {
    ...
    "artifact_delete": {
        ...
        "error_codes": [],
        "examples": [
            {"summary": "Delete an artifact", "args": {"slug": "launch-plan"}}
        ],
    },
    "image_generate": {
        "response_type": "artifact.detail",
    ...
    "workflow_get_def": {
        ...
        "error_codes": [],
        "examples": [
            {"summary": "Read one definition", "args": {"name": "triage-inbox"}}
        ],
    },
    "workflow_start": {
    ...
    "workflow_delete_def": {
        ...
        "error_codes": [],
        "examples": [
            {"summary": "Delete a definition", "args": {"name": "old-workflow"}}
        ],
    },
    "memory_remember": {
    ...
    "subagent_status": {
        ...
        "examples": [
            {
                "summary": "Check one subagent's status",
                "args": {"agent_id": "sub-abc123"},
            }
        ],
    },
    "post_to_inbox": {
    ...
    "knowledge_get": {
        ...
        "error_codes": [],
        "examples": [
            {"summary": "Read a knowledge item by id", "args": {"id": "kn_abc123"}}
        ],
    },
    "knowledge_update": {
        "response_type": "knowledge.detail",
        ...
        "examples": [
            {
                "summary": "Pin a knowledge item",
                "args": {"id": "kn_abc123", "is_pinned": True},
            }
        ],
    },
    "knowledge_stats": {
    ...
    "project_run_start": {
        ...
        "examples": [
            {
                "summary": "Start a created project run",
                "args": {"project_id": "prj_abc123"},
            }
        ],
    },
    "project_run_status": {
        ...
        "examples": [
            {
                "summary": "Check a project run's status",
                "args": {"project_id": "prj_abc123"},
            }
        ],
    },
    "project_run_list": {
        ...
        "examples": [
            {
                "summary": "List recent project runs",
                "args": {"kind": "code", "limit": 10},
            }
        ],
    },
    "log_decision": {
    ...
    "decision_list": {
        ...
        "examples": [
            {
                "summary": "List decisions past their review horizon",
                "args": {"status": "overdue"},
            }
        ],
    },
    ...
    "task_list": {
        ...
        "error_codes": [],
        "examples": [
            {"summary": "List open tasks", "args": {"status": "open", "limit": 20}}
        ],
    },
    "task_get": {
        "response_type": "task.detail",
        ...
        "examples": [
            {
                ...
                "args": {"id": "tsk_abc123", "status": "done"},
            }
        ],
    },
    "task_ready": {
        ...
        "examples": [
            {
                "summary": "List tasks whose dependencies are met",
                "args": {"project": "launch"},
            }
        ],
    },
        ...
        "examples": [
            {
                ...
                "args": {"query": "email", "status": ["open"], "limit": 20},
            }
        ],
    },
    "project_create": {
        ...
        "error_codes": [],
        "examples": [
            {"summary": "Create a project to group tasks", "args": {"name": "Launch"}}
        ],
    },
    "project_list": {
