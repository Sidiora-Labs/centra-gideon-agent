...
``strip_thinking_tags``) live in :mod:`gideon.textfmt` and are re-exported
here for the Slack modules that use them alongside the mrkdwn/Block-Kit builders.
"""

import re

from gideon.sdk.channel import extract_options, strip_thinking_tags
...
def to_slack_desk_mrkdwn(text: str, *, keep_tables: bool = False) -> str:
