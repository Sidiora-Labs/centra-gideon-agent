...
:mod:`gideon.extensions.apps.schema_validate`); what is specific to apps stays here — unknown keys
...
def validate_config(values: dict[str, Any], schema: dict[str, Any]) -> list[str]:
    ...
    constraints — live in :mod:`gideon.extensions.apps.schema_validate`, shared with the provider
