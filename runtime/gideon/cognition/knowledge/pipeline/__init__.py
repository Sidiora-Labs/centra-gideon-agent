...
:class:`~gideon.cognition.knowledge.pipeline.graph.PipelineGraph`; the
:class:`~gideon.cognition.knowledge.pipeline.executor.PipelineExecutor` runs its nodes
...
def ensure_nodes_registered() -> None:
    ...
    if _REGISTERED:
        return
    from gideon.cognition.knowledge.pipeline.nodes import media_nodes, text_nodes
