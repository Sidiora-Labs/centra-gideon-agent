...
from gideon.workspace.capabilities.platform.references import ReferenceError, add, change, view
        ...
        if request.method != 'GET':
            ...
            async with _get_config_lock():
                if 'id' not in request.match_info:
                    ...
                    await asyncio.to_thread(change, request.match_info['id'], 'remove' if request.method == 'DELETE' else request.match_info['action'], body)
