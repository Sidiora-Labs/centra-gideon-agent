...
from gideon.workspace.capabilities.wellbeing.privacy_broker_whitepages import WhitepagesCaseAdapter
...
def register(app, home=None, adapter=None):
    ...
    app.router.add_get('/api/capabilities/wellbeing/privacy/broker-cases/{id}/providers/whitepages', status)
    app.router.add_post('/api/capabilities/wellbeing/privacy/broker-cases/{id}/providers/whitepages/{action:prepare|approve|send|correlate}', action)
