...
from gideon.workspace.capabilities.platform.inference_host import current, HostError
...
async def endpoint(request):
    ...
    try:
        ...
        return web.json_response({'error': 'Inference host unavailable or invalid configuration'}, status=400)
