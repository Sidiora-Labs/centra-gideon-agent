...
async def start_dashboard(
    ...
    app.router.add_get(
        "/api/memory/embedding-status", handlers.api_memory_embedding_status
    )
    app.router.add_post(
        "/api/memory/enable-embeddings", handlers.api_memory_enable_embeddings
    )
    app.router.add_post(
        "/api/memory/disable-embeddings", handlers.api_memory_disable_embeddings
    )
    app.router.add_get(
        "/api/memory/embedding-models", handlers.api_memory_embedding_models
    )
    app.router.add_post("/api/memory/delete-model", handlers.api_memory_delete_model)
    app.router.add_post(
        "/api/memory/activate-model", handlers.api_memory_activate_model
    )
    app.router.add_get(
