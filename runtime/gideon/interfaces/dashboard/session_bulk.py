...
from gideon.interfaces.dashboard.chat_tags import known_tag_ids
from gideon.interfaces.dashboard.session_lifecycle import (
    LIFECYCLE_ACTIVE,
    LIFECYCLE_ARCHIVED,
    run_auto_archive,
    set_lifecycle,
...
def register_routes(app: web.Application) -> None:
    ...
    app.router.add_post(
        "/api/chat/sessions/auto-archive", api_chat_sessions_auto_archive
    )
    app.router.add_patch(
        "/api/chat/sessions/{session}/lifecycle", api_chat_session_lifecycle
    )
