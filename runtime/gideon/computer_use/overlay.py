...
:func:`gideon.computer_use.service.computer_dispatch`, between the approved SEL row and
...
(the same reasoning as :func:`gideon.computer_use.gate.require_computer_use`): a malformed
...
every string is passed through :func:`gideon.security.redact_credentials` on the way
