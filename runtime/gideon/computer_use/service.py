...
:mod:`gideon.computer_use.driver_host`, spawned through
...
DRIVER_CHILD_MODULE = "gideon.computer_use.driver_host"
...
def _redact_result(spec: ToolSpec, result: dict[str, Any]) -> dict[str, Any]:
    ...
    * every string a driver produced is passed through
      :func:`gideon.security.redact_credentials`, this codebase's one definition of
...
async def computer_dispatch(
    ...
    *,
    ...
    Raises :class:`~gideon.computer_use.enable_state.ComputerUseDisabled`,
    :class:`~gideon.computer_use.policy.ComputerUsePolicyRefusal` or
