...
(:func:`gideon.computer_use.policy.check_input_target`) at the mercy of whichever driver
...
class DriverError:
    ...
    gives the driver layer what :class:`~gideon.errors.AgentError` gives the agent layer:
    ...
    def to_dict(self) -> dict[str, Any]:
        """The envelope :mod:`~gideon.computer_use.driver_host` forwards on stdout."""
        return {
