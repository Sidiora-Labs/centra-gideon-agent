...
:mod:`~gideon.computer_use.macos_ffi`. There is no accessibility API that reports the
...
:data:`~gideon.computer_use.service.DRIVER_TIMEOUT_SECS` (20s) to answer, and a refusal's
