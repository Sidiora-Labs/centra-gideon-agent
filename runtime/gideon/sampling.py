...
temperature-varied :func:`~gideon.llm_helpers.one_shot_completion` calls, has
:class:`~gideon.eval.judge.LLMJudge` score every survivor against
...
* **Through the chokepoint.** Each sample rides ``one_shot_completion`` → the
  use-case bridge → :class:`~gideon.guardrails.model_call.ModelCallGuard`, so
