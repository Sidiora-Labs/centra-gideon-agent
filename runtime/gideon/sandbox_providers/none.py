...
sandbox (:func:`gideon.sandbox.wrap_argv`) and the post-exec resource ceilings
(:func:`gideon.sandbox.create_subprocess_limited`) — and adds NO further isolation. It
...
from gideon.sandbox import create_subprocess_limited, wrap_argv
