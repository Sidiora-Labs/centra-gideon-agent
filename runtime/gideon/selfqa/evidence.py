...
(:func:`gideon.sandbox_providers.docker.docker_available`): a cached result with a short
...
(:func:`gideon.workflows.verify.check_required_artifacts`, WF2-R3): where that one refuses a
...
def ffmpeg_available(*, refresh: bool = False) -> bool:
    ...
    exactly as :func:`gideon.sandbox_providers.docker.docker_available` caches its daemon
    ping.
    """
    global _probe_cache
    now = time.monotonic()
