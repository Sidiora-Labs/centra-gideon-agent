...
from gideon.apps.backend_runtime import _TERM_TIMEOUT, BackendSupervisor
...
from gideon.apps.background import (
...
class WorkerSupervisor:
    ...
    def _child_env(self, rec: SupervisedWorker) -> dict[str, str]:
        ...
        * **the per-app proxy secret.** ``APP_SECRET_ENV`` exists so a backend can VERIFY
        ...
        """
        from gideon.apps.backend_runtime import shared_storage_env
        from gideon.apps.background import WORKER_ID_ENV
