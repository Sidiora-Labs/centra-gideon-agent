...
places: system memory in :mod:`gideon.local_models.residency`, the GPU/VRAM probe in
...
def configured_reserve_gb() -> float:
    ...
    Mirrors :func:`gideon.local_models.residency._warn_pct_default`: a host-fact
