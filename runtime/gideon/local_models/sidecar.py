...
class SidecarInstall:
    ...
    def for_app(cls, app: str) -> "SidecarInstall | None":
        ...
        """
        from gideon.apps.manager import APP_MANIFEST_FILENAME, app_dir
        from gideon.apps.manifest import EXECUTION_SIDECAR, AppManifest
    ...
    def _run(self, argv: list[str], *, timeout: int) -> None:
        ...
        from gideon.sandbox import PROFILE_BUILD, build_child_env, spawn_shim_argv
