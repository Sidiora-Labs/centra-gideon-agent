"""Portability API handlers — export/import Gideon state as zip."""
...
from gideon.portability import apply_import_zip, create_export_zip, validate_import_zip
...
async def api_portability_export(request: web.Request) -> web.Response:
    ...
    filename = f"gideon-export-{ts}.zip"
