...
:mod:`gideon.api_version` owns the numbers, the window and the comparison;
...
:func:`gideon.api_version.negotiate` has exactly one non-test caller,
...
from gideon.api_version import VERSION_HEADER, negotiate
