...
from gideon.assurance.ledger.hashing import stable_json
from gideon.assurance.ledger.kinds import LEDGER_KINDS, STEP_CACHED, STEP_COMPLETED
from gideon.assurance.ledger.outcomes import OutcomeLedger
...
class LedgerStore(Protocol):
    ...
    def append_jsonl(
        self, run_id: str, filename: str, record: dict[str, Any]
    ) -> None: ...
...
class LedgerWriter(OutcomeLedger):
    ...
    :class:`gideon.assurance.ledger.outcomes.OutcomeLedger`, so every producer that can carry a ledger
