...
defined once in :mod:`gideon.extensions.manifest` and only ever *emitted* — into
...
chokepoint (:mod:`gideon.interfaces.dashboard.api_version_gate`), and a mismatch
...
def negotiate(
    ...
    *,
    ...
    (:mod:`gideon.interfaces.dashboard.api_version_gate`).
