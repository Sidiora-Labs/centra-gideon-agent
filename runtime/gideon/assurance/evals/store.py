...
:mod:`gideon.assurance.evals.scenarios`). ES-4 added ``benchmarks/`` and ES-5 adds
...
def study_locked_dir(study_id: str) -> Path:
    ...
    is :func:`gideon.assurance.evals.studies.assert_no_locked_leakage`; this is the floor
    under it.
    """
...
def append_result(row: dict, *, pin: "RunPin") -> None:
    ...
    :class:`~gideon.assurance.evals.pinning.RunPin` raises :class:`PinRequiredError`
