...
* **Use-case vocabulary** — :mod:`gideon.extensions.providers.prompt_use_cases` derives
...
from gideon.integrations.prompt_providers.base import PromptVariable
...
BUNDLED_PROMPTS: tuple[BundledPrompt, ...] = (
    ...
    BundledPrompt(
        ...
        variables=(
            PromptVariable(
                ...
                type="textarea",
                required=True,
                description="The new lesson rule.",
            ),
            PromptVariable(
                name="existing_rule",
                type="textarea",
    ...
    BundledPrompt(
        ...
        variables=(
            PromptVariable(
                name="user_name",
                required=True,
                description="Who the reply is on behalf of.",
            ),
            PromptVariable(
                name="channel", required=True, description="The channel/DM name."
            ),
    ...
    BundledPrompt(
        ...
        variables=(
            PromptVariable(
                name="channel", required=True, description="The channel name."
            ),
            PromptVariable(
                name="hours",
                required=True,
                description="The look-back window in hours.",
            ),
            PromptVariable(
                name="user_name", required=True, description="Whose attention to flag."
            ),
            PromptVariable(
                name="messages",
                type="textarea",
    ...
    BundledPrompt(
        ...
        variables=(
            PromptVariable(
                name="folder_name", required=True, description="The folder name."
            ),
        ),
    ),
    BundledPrompt(
    ...
    BundledPrompt(
        ...
        variables=(
            PromptVariable(
                ...
                type="textarea",
                required=True,
                description="The goal to assess.",
            ),
        ),
    ),
    BundledPrompt(
    ...
    BundledPrompt(
        ...
        variables=(
            PromptVariable(
                name="loop_id", required=True, description="The parent loop id."
            ),
            PromptVariable(
                name="worktree_dir",
                required=True,
            ...
            PromptVariable(
                name="task_title", required=True, description="The task's title."
            ),
    ...
    BundledPrompt(
        ...
        variables=(
            ...
            PromptVariable(
                name="step_kind", required=True, description="This step's kind slug."
            ),
            PromptVariable(
                name="objective",
                type="textarea",
    ...
    BundledPrompt(
        ...
        variables=(
            ...
            PromptVariable(
                ...
                type="textarea",
                required=True,
                description="The goal to classify.",
            ),
        ),
    ),
    BundledPrompt(
    ...
    BundledPrompt(
        ...
        variables=(
            PromptVariable(
                ...
                type="textarea",
                required=True,
                description="The design task to phase.",
            ),
        ),
    ),
    BundledPrompt(
        ...
        variables=(
            PromptVariable(
                name="stage_title", required=True, description="The stage title."
            ),
            PromptVariable(
                name="objective",
                type="textarea",
                default="",
                description="The stage objective.",
            ),
            PromptVariable(
                name="criteria",
                type="textarea",
...
BUNDLED_SNIPPETS: tuple[BundledSnippet, ...] = (
    ...
    BundledSnippet(
        ...
        variables=(
            ...
            PromptVariable(
                name="thread_ts", required=True, description="Thread timestamp."
            ),
            PromptVariable(
    ...
    BundledSnippet(
        ...
        variables=(
            PromptVariable(
                name="agent_label",
                required=True,
                description="The running agent's name.",
            ),
            PromptVariable(
                name="runtime",
                required=True,
