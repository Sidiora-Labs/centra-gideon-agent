...
Today this is discovery only (:mod:`gideon.integrations.companion.discovery`): an optional
...
in the auth layer (``gideon.security.auth.enrollment`` and the token rail) — nothing here
