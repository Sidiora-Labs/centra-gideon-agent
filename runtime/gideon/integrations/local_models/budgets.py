...
hardcoded table of *hosted* model ids (:mod:`gideon.integrations.model_windows`, whose
...
(:mod:`gideon.automation.workflows.compaction`) and it is untouched here.
"""
...
class ContextBudget:
    ...
    * ``"window-table"`` — no catalog fact; :func:`gideon.integrations.model_windows.
...
async def catalog_window(model_ref: str) -> tuple[int, int]:
    ...
    """
    from gideon.integrations.local_models.registry import get_provider, list_providers
