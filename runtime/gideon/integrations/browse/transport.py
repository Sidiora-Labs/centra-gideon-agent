"""The real CDP wire behind :class:`gideon.integrations.browse.cdp.CdpTransport` (BA-2).
...
:meth:`~gideon.integrations.browse.cdp.GatedCdpSession.handle_event` at all. This module is that
    ...
    async def _dispatch_loop(self) -> None:
        ...
        while True:
            ...
            try:
                ...
                logger.warning(
                    "browse: CDP event listener raised on %s", method, exc_info=True
                )
