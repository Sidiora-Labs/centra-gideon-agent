...
Mirrors :mod:`gideon.integrations.sync_transports.registry` and ``channel_transports``: the ``none``
...
:class:`gideon.extensions.providers.registry.SandboxTypeHandler`. Spawn sites resolve the configured
...
if TYPE_CHECKING:
    from gideon.integrations.sandbox_providers.base import SandboxProvider
...
def register_builtin_providers() -> None:
    ...
    """
    from gideon.integrations.sandbox_providers.docker import DockerSandboxProvider
