...
async def invoke_substances(home, arguments):
    ...
    methods = {"entry_create": store.create_entry, "entry_correct": store.correct_entry, "entry_delete": store.delete_entry, "entry_get": store.get_entry, "entry_history": store.history_entry, "entry_list": store.list_entries, "preset_create": store.create_preset, "preset_update": store.update_preset, "preset_delete": store.delete_preset, "preset_list": store.list_presets, "summary": store.summary}
    ...
    elif operation in ("entry_correct", "entry_delete", "preset_update", "preset_delete"):
