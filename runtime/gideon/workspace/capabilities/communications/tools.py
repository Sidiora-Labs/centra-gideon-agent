...
STRING = {"type": "string"}
IDENTITY = obj(
    {"kind": {"enum": ["email", "phone", "handle"]}, "value": STRING}, ("kind", "value")
)
PERSON = obj(
    {
        "name": STRING,
        "identities": {"type": "array", "items": IDENTITY, "maxItems": 100},
...
BATCH = obj(
    {
        ...
        "coverage_end": STRING,
        "incoming_complete": {"type": "boolean"},
        "outgoing_complete": {"type": "boolean"},
...
ACCOUNT = obj(
    {key: STRING for key in mirrors.ACCOUNT_FIELDS}, ("name", "kind", "owner_email")
)
DESKTOP = {
    "source": {"enum": ["imessage", "signal"]},
    "source_account_id": STRING,
...
TGCONFIG = {
    ...
    "automatic_replies": {"type": "boolean"},
    "bot_credential_ref": STRING,
    "webhook_credential_ref": STRING,
    "allowed_chat_ids": {"type": "array", "items": {"type": "integer"}, "maxItems": 50},
    "allowed_user_ids": {"type": "array", "items": {"type": "integer"}, "maxItems": 50},
    "revision": {"type": "integer", "minimum": 0},
}
CAL_SOURCE = {key: STRING for key in calendar.SOURCE_FIELDS}
SOCIAL = {
    **{key: STRING for key in social.FIELDS if key != "person_id"},
...
SPECS = {
    ...
    "people_platform_assignment_get": (
        ...
        obj({"assignment_id": STRING}, ("assignment_id",)),
        False,
    ),
    "people_platform_assignment_create": (
        ...
        obj(
            {
                "account_id": STRING,
                "account_revision": {"type": "integer"},
                "agent_id": STRING,
                "reason": STRING,
                "request_key": STRING,
            },
            ("account_id", "account_revision", "agent_id", "reason", "request_key"),
        ),
        True,
    ),
    "people_platform_assignment_change": (
        ...
        obj(
            ...
            ("assignment_id", "revision", "account_revision", "state", "reason"),
        ),
        True,
    ),
                ...
                "action": obj(
                    {
                        **{
                            key: STRING
                            for key in stacker.ACTION_FIELDS
                            if key != "sats"
                        },
                        "sats": {"type": "integer"},
                        "request_key": STRING,
                    },
                    ("kind", "territory", "request_key"),
                ),
            },
            ("account_id", "action"),
        ),
    ...
    "people_stacker_review": (
        ...
        obj(
            ...
            ("account_id", "action_id", "revision", "confirm_review"),
        ),
        True,
    ),
    "people_stacker_submit": (
        ...
        obj(
            ...
            ("account_id", "action_id", "revision", "confirm_execute"),
        ),
        True,
    ),
    "people_stacker_reconcile": (
        "Read actual provider PayIn state without paying or retrying.",
        obj({"account_id": STRING, "action_id": STRING}, ("account_id", "action_id")),
        True,
    ),
    "people_x_snapshot": (
    ...
    "people_x_sync": (
        ...
        obj({"account_id": STRING, "pagination_token": STRING}, ("account_id",)),
        True,
    ),
    "people_x_drafts": (
    ...
    "people_x_draft_create": (
        ...
        obj(
            {"account_id": STRING, "text": STRING, "request_key": STRING},
            ("account_id", "text", "request_key"),
        ),
        True,
    ),
    "people_x_draft_update": (
        ...
        obj(
            ...
            ("account_id", "draft_id", "text", "revision"),
        ),
        True,
    ),
    "people_x_review": (
        ...
        obj(
            ...
            ("account_id", "draft_id", "revision", "confirm_review"),
        ),
        True,
    ),
    ...
    "people_social_create": (
        ...
        obj(
            {
                "account": obj(
                    {**SOCIAL, "request_key": STRING},
                    ("platform", "handle", "request_key"),
                )
            },
            ("account",),
        ),
        ...
        obj(
            {
                "account_id": STRING,
                "account": obj(
                    {**SOCIAL, "revision": {"type": "integer", "minimum": 1}},
                    ("platform", "handle", "revision"),
                ),
            },
            ("account_id", "account"),
        ),
    ...
    "people_social_remove": (
        ...
        obj(
            {"account_id": STRING, "revision": {"type": "integer", "minimum": 1}},
            ("account_id", "revision"),
        ),
        True,
    ),
    ...
    "people_calendar_create": (
        ...
        obj({"source": obj(CAL_SOURCE, ("name", "kind"))}, ("source",)),
        True,
    ),
        ...
        obj(
            {
                "source_id": STRING,
                "source": obj(
                    {**CAL_SOURCE, "revision": {"type": "integer", "minimum": 1}},
                    ("name", "kind", "revision"),
                ),
            },
            ("source_id", "source"),
    ...
    "people_calendar_sync": (
        ...
        obj(
            {"source_id": STRING, "start": STRING, "end": STRING},
            ("source_id", "start", "end"),
        ),
        True,
    ),
    "people_calendar_daily": (
        ...
        obj({"date": STRING, "timezone": STRING}, ("date",)),
        False,
    ),
    ...
    "people_telegram_send": (
        ...
        obj(
            {"delivery_id": STRING, "confirm_send": {"const": True}},
            ("delivery_id", "confirm_send"),
        ),
        True,
    ),
    ...
    "people_beeper_configure": (
        ...
        obj(
            ...
            ("base_url", "credential_ref", "revision"),
        ),
        True,
    ),
    "people_beeper_disconnect": (
        ...
        obj({"revision": {"type": "integer", "minimum": 0}}, ("revision",)),
        True,
    ),
    "people_beeper_page": (
    ...
    "people_beeper_refresh": (
        ...
        obj({"chat_id": STRING, "cursor": STRING}),
        True,
    ),
    "people_beeper_asset_fetch": (
        "Fetch a mirrored attachment by its Beeper media identity.",
        obj({"chat_id": STRING, "asset_id": STRING}, ("chat_id", "asset_id")),
        True,
    ),
    "people_beeper_asset": (
        "Read cached attachment bytes.",
        obj({"asset_id": STRING}, ("asset_id",)),
        False,
    ),
    ...
    "people_beeper_draft": (
        ...
        obj(
            {"request_key": STRING, "chat_id": STRING, "text": STRING},
            ("request_key", "chat_id", "text"),
        ),
        True,
    ),
    "people_beeper_send": (
        ...
        obj(
            {**OUTBOX_ACTION, "confirm_send": {"const": True}},
            (*OUTBOX_ACTION, "confirm_send"),
        ),
        True,
    ),
    "people_beeper_reconcile": (
        "Read Beeper status for a pending ID without resending.",
        obj(OUTBOX_ACTION, OUTBOX_ACTION),
        True,
    ),
    ...
    "people_desktop_commit": (
        ...
        obj(
            {**DESKTOP, "source_digest": STRING, "review_token": STRING},
            (*DESKTOP, "source_digest", "review_token"),
        ),
        True,
    ),
    ...
    "people_desktop_history": (
        ...
        obj(
            {"source": STRING, "source_account_id": STRING},
        ...
        obj(
            {
                **DESKTOP_REF,
                "external_id": STRING,
                "scope": {"enum": ["message", "identity"]},
            },
            (*DESKTOP_REF, "external_id", "scope"),
        ),
        True,
    ),
        ...
        obj(
            {
                ...
                "account": obj(
                    ...
                    ("name", "kind", "owner_email", "revision"),
                ),
            },
            ("account_id", "account"),
        ),
    ...
    "people_get": (
        ...
        obj({"person_id": STRING, "timezone": STRING}, ("person_id",)),
        False,
    ),
    "people_create": (
    ...
    "people_record_touchpoint": (
        ...
        obj({"person_id": STRING, "touchpoint": TOUCH}, ("person_id", "touchpoint")),
        True,
    ),
    "people_import_preview": (
        "Preview bounded CSV or vCard contacts without writing people.",
        obj(IMPORT, ("format", "content")),
        False,
    ),
        ...
        obj(
            {
                **IMPORT,
                ...
                "decisions": {"type": "array", "items": DECISION, "maxItems": 500},
            },
            ("format", "content", "source_digest", "decisions"),
        ),
        True,
    ),
        ...
        return [
            ToolDefinition(
                ...
                risk_level=(
                    ...
                    else RiskLevel.CAUTION if write else RiskLevel.SAFE
                ),
            )
        ...
        try:
            ...
            if tool_name == "people_activity_timeline":
                ...
                if action == "agents":
                    ...
                    result = {
                        "assignment": lifecycle.get(store, arguments["assignment_id"])
                    }
                elif action == "assignment_history":
                    result = {
                        "history": lifecycle.history(store, arguments["assignment_id"])
                    }
                ...
                data = {
                    k: v
                    for k, v in arguments.items()
                    if k not in ("account_id", "action_id")
                }
                if action == "territories":
                    ...
                    result = {
                        "actions": stacker.actions(store, arguments["account_id"])
                    }
                elif action == "prepare":
                    result = {
                        "action": stacker.save(
                            store, arguments["account_id"], arguments["action"]
                        )
                    }
                elif action == "review":
                    result = {
                        "action": stacker.review(
                            store, arguments["account_id"], arguments["action_id"], data
                        )
                    }
                else:
                    result = {
                        "action": await (
                            stacker.submit if action == "submit" else stacker.reconcile
                        )(store, arguments["account_id"], arguments["action_id"], data)
                    }
                ...
                data = {
                    k: v
                    for k, v in arguments.items()
                    if k not in ("account_id", "draft_id")
                }
                if action == "snapshot":
                    result = {
                        "snapshot": xreading.snapshot(store, arguments["account_id"])
                    }
                elif action == "sync":
                    result = {
                        "snapshot": await xreading.sync(
                            store, arguments["account_id"], data
                        )
                    }
                elif action == "drafts":
                    ...
                    result = {
                        "draft": xreading.review(
                            store, arguments["account_id"], arguments["draft_id"], data
                        )
                    }
                else:
                    result = {
                        "draft": xreading.save_draft(
                            store,
                ...
                if action == "accounts":
                    ...
                    result = {"account": social.get(store, arguments["account_id"])}
                elif action == "history":
                    result = {"history": social.history(store, arguments["account_id"])}
                elif action == "remove":
                    result = social.remove(
                        store, arguments["account_id"], arguments["revision"]
                    )
                else:
                    row, created = social.save(
                        store, arguments["account"], arguments.get("account_id")
                    )
                    result = {"account": row, "created": created}
            elif tool_name.startswith("people_calendar_"):
                action = tool_name.removeprefix("people_calendar_")
                if action == "sources":
                    result = {"sources": calendar.sources(store)}
                elif action in ("create", "update"):
                    result = {
                        "source": calendar.save_source(
                            store, arguments["source"], arguments.get("source_id")
                        )
                    }
                elif action == "upload":
                    result = {
                        "sync": calendar.upload(
                            store,
                            arguments["source_id"],
                            {k: v for k, v in arguments.items() if k != "source_id"},
                        )
                    }
                elif action == "sync":
                    result = {
                        "sync": await calendar.sync_remote(
                            store,
                            arguments["source_id"],
                            {k: v for k, v in arguments.items() if k != "source_id"},
                        )
                ...
                if action == "config":
                    ...
                    result = {
                        "delivery": await asyncio.to_thread(
                            telegram.deliver, store, arguments["delivery_id"]
                        )
                    }
                ...
                if action == "settings":
                    ...
                    result = await beeper.refresh(
                        store, arguments.get("chat_id"), arguments.get("cursor")
                    )
                elif action == "asset_fetch":
                    result = await beeper.fetch_asset(
                        store, arguments["chat_id"], arguments["asset_id"]
                    )
                elif action == "asset":
                    ...
                    result = {
                        "item": await beeper.send(
                            store,
                            arguments["outbox_id"],
                            {k: v for k, v in arguments.items() if k != "outbox_id"},
                        )
                    }
                else:
                    ...
                    row = (
                        await operation(
                            store, arguments["outbox_id"], arguments["revision"]
                        )
                        if action == "reconcile"
                        else operation(
                            store, arguments["outbox_id"], arguments["revision"]
                ...
                result = {
                    "messages": desktop.history(
                        store, arguments["source"], arguments["source_account_id"]
                    )
                }
            elif tool_name == "people_desktop_exclusions":
                result = {
                    "exclusions": desktop.exclusions(
                        store, arguments["source"], arguments["source_account_id"]
                    )
                }
                ...
                result = {
                    "sync": await asyncio.to_thread(
                        mirrors.sync, store, arguments["account_id"]
                    )
                }
                ...
                result = {
                    "people": [
                        {**row["person"], "care": row["care"]}
                        for row in report(store, zone)["people"]
                    ]
                }
                ...
                result = {
                    "person": store.save(
                        arguments["person"], arguments.get("person_id")
                    )
                }
            elif tool_name == "people_record_touchpoint":
                point, created = store.record(
                    arguments["person_id"], arguments["touchpoint"]
                )
            ...
            return ToolResult(
                ...
                recovery_hints=[
                    "Reload the current person or preview and submit valid arguments with its current revision."
                ],
            )
