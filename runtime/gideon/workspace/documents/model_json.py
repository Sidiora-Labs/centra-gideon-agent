...
def _style(payload: Any, where: str) -> ParagraphStyle | None:
    ...
    return ParagraphStyle(
        ...
        space_before_pt=_number(
            data.get("space_before_pt"), f"{where}.space_before_pt"
        ),
        ...
        indent_right_pt=_number(
            data.get("indent_right_pt"), f"{where}.indent_right_pt"
        ),
...
def _page(payload: Any, where: str) -> PageSetup | None:
    ...
    return PageSetup(
        ...
        margin_bottom_pt=_number(
            data.get("margin_bottom_pt"), f"{where}.margin_bottom_pt"
        ),
        margin_left_pt=_number(data.get("margin_left_pt"), f"{where}.margin_left_pt"),
        margin_right_pt=_number(
            data.get("margin_right_pt"), f"{where}.margin_right_pt"
        ),
