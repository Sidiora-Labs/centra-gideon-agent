...
// path (<root>/.gideon-worktrees/<task_id>/<rel>, deleted post-merge → remap to the
...
export function CodeCockpitPage({ id, onBack, onDeleted, onNewTarget, onOpenProject, onStartNew, query, setQuery }: {
  ...
  async function del() {
    ...
    // force-deletes `gideon/task-*` branches in the user's repository. `codeMeta.codeDeleteBody` owns
