...
export const ArtifactGrid = memo(function ArtifactGrid({ artifacts, activeSlug, onOpen }: {
  artifacts: Artifact[]
  activeSlug: string | null
  onOpen: (a: Artifact) => void
}) {
  if (!artifacts.length) {
    return <EmptyState icon={Box} title="No artifacts" hint="Artifacts are named, versioned snapshots — widgets, docs, images, and files agents produce. Ask the agent to save one, or save a file as an artifact from the Files page." />
  }
  return (
