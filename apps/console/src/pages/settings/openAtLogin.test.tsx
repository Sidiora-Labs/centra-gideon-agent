 ...
 *  `gideonDesktop.loginItem.get/set` and `main.js` registered the IPC, but
 ...
 *  SIMULATED: `window.gideonDesktop` is a recording double — it exists only inside Electron.
...
/** The recording double for `gideonDesktop.loginItem`. `sets` is the observable that
