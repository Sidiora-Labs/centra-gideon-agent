...
export default function Moltworld({baseUrl='/api/capabilities/experience'}:{baseUrl?:string}) {
  ...
  return <section aria-label="Moltworld adapter" className="space-y-m">
    <h2 data-type="title-m">Moltworld</h2><p>External actions require approval. A queued receipt is not proof that the tick completed.</p>
