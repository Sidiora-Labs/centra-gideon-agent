...
function SketchPage() {
  ...
  return <section className="p-4 space-y-4 overflow-auto" aria-label="Image sketches">
    ...
    {sketch && <>
      ...
      <a href="#/capabilities/media?view=jobs">Media jobs</a><a href="#/capabilities/media?view=readiness">Media readiness</a><a href="#/capabilities/media?view=images">Generate image</a><a href="#/capabilities/media?view=datasets">Training datasets</a>
...
export default function Page() {
  ...
  return view === 'datasets' ? <DatasetsPage /> : view === 'images' ? <ImagePage /> : view === 'readiness' ? <Readiness /> : view === 'jobs' ? <JobsPage /> : view === 'library' ? <LibraryPage /> : <SketchPage />
}
