...
<a href="#/capabilities/media?view=jobs">Media jobs</a><a href="#/capabilities/media?view=readiness">Media readiness</a><a href="#/capabilities/media?view=images">Generate image</a><a href="#/capabilities/media?view=datasets">Training datasets</a><a href="#/capabilities/media?view=episodes">Continuous episodes</a><a href="#/capabilities/media?view=timelines">Video timeline</a><a href="#/capabilities/media?view=videos">Generate video</a><a href="#/capabilities/media?view=cleanup">Image cleanup</a></nav>
...
export default function Page() {
  ...
  return view === 'episodes' ? <EpisodePage /> : view === 'timelines' ? <TimelinePage /> : view === 'videos' ? <VideoPage /> : view === 'cleanup' ? <CleanupPage /> : view === 'datasets' ? <DatasetsPage /> : view === 'images' ? <ImagePage /> : view === 'readiness' ? <Readiness /> : view === 'jobs' ? <JobsPage /> : view === 'library' ? <LibraryPage /> : <SketchPage />
}
