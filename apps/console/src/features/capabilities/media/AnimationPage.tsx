...
export default function AnimationPage() {
  ...
  return <main className="p-4 space-y-4"><h1>Code animation</h1><a href="#/capabilities/media?view=jobs">Animation jobs</a><p>Generate an original, self-contained HTML animation with the selected reasoning model. A successful job stores the exact validated model response as a canonical artifact. External network access and assets are rejected; local success does not claim external model availability.</p>
