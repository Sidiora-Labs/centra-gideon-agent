...
export default function Page({ baseUrl = '' }: { baseUrl?: string }) {
  ...
  return <main className="min-w-0 space-y-l p-l text-on-surface">
    ...
    <Composition baseUrl={baseUrl} /><Forecast baseUrl={baseUrl} /><Cadence baseUrl={baseUrl} /><PrScreening baseUrl={baseUrl} /><Maintenance baseUrl={baseUrl} /><Gsd baseUrl={baseUrl} />
