...
export default function Migration({ baseUrl = '' }: { baseUrl?: string }) {
  ...
  return <section aria-label="Archive migration" className="space-y-m">
    ...
    <p>Verified imports currently cover version-1 people, projects, admin actions, tracked threads, ideas, journals, memories, links, buckets, inbox captures, and song sheets with verified attachments. Mixed song archives commit as independent canonical-record and song groups after full-plan validation. Completed groups are retained, unfinished groups resume only from the exact reviewed archive, and partial completion is reported without claiming archive-wide rollback. Inbox capture history remains a separate atomic import. Settings, logs, relational dumps, unrelated media, and reference files remain refused.</p>
