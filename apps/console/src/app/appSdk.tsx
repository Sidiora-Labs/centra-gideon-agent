...
//   useChatLauncher — open a Gideon chat session (A8 ChatEmbed extends this).
//
...
/** IMPERATIVE: open a Gideon chat session (navigates the host to a full chat
...
/** Open a Gideon chat session from a contributed app — navigates the host to a
 *  full chat view. For an in-place embed, use {@link ChatEmbed}. */
export function useChatLauncher() {
  return launchChat
}

/** Embed a live Gideon chat session inside a contributed app's own UI (A8).
