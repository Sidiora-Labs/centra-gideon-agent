...
export type ThreadFollowupSuggestionsProps = {
  onPick?: (prompt: string) => void;
  sendOnSelect?: boolean;
};

const FollowupSuggestionsRow: FC<ThreadFollowupSuggestionsProps> = ({ onPick, sendOnSelect = true }) => {
...
export const ThreadFollowupSuggestions: FC<ThreadFollowupSuggestionsProps> = (props) => (
  <AuiIf
    condition={(s) =>
      !s.thread.isEmpty &&
      !s.thread.isRunning &&
