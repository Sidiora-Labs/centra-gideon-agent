...
const docs: UiDoc[] = [
  ...
  {
    name: 'EmptyState',
    keywords: ['empty', 'state', 'placeholder', 'zero', 'cta', 'blank', 'onboarding', 'gideon'],
    description:
      'The uniform empty state for a list/panel — a centered icon (the Spark gideon mark by default, or a supplied Lucide icon in a tinted tile), a headline, an optional subline, and an optional call-to-action Button. Use it wherever a collection is empty so every zero state reads the same.',
    props: [
      ...
      { name: 'icon', description: 'Optional Lucide icon shown in a tinted tile; omit to fall back to the Spark gideon mark.' },
    ...
    anatomy: ['centered column', 'icon tile (Lucide) or Spark gideon mark', 'headline + optional hint', 'optional CTA Button'],
  },
  {
    name: 'Loading',
