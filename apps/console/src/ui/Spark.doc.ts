...
const docs: UiDoc[] = [
  {
    ...
    description:
      'The Gideon brand mark used as the AI motif throughout the app — the thinking indicator, loop cycle nodes, empty states. Renders the claw logo (via ClawMark) painted with the ACTIVE scheme gradient, NOT the Gemini sparkle. Each instance gets a unique gradient id so multiple Sparks on a page never collide.',
    props: [
