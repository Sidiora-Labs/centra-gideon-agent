...
const doc: UiDoc = {
  ...
  props: [
    ...
    { name: 'contextPct', description: '0–100 context-window usage for the bound session → ring on the model pill. Omit it (undefined) when the backend reported no measurement — the pill shows a plain dot instead of a fabricated 0%.' },
