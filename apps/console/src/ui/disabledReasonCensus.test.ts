...
const CLASSIFIED: Record<string, string> = {
  ...
  'pages/knowledge/KnowledgeListPage.tsx:899': "the reason is the button's own label text",
...
describe('the disabled-reason census', () => {
  ...
  it('each classified site still has the shape it is excused for', () => {
    ...
    expect(at('pages/knowledge/KnowledgeListPage.tsx', 899)).toMatch(/disabled=\{!o\.item_id\}/)
