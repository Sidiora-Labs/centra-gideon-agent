...
- **Action providers:** none added; `ALLOWED_HOOK_PROVIDERS` (`src/gideon/validation.py`) is untouched. (Restated per platform rule: any future action provider must be added there or hook create/update rejects it.)
