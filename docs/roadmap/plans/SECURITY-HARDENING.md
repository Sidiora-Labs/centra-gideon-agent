...
`.gideon-signature.sha256` (`gideon-sig-v1` header, then a sorted `sha256  relpath` line for **every**
file) and `.gideon-signature.sha256.minisig` over that file's exact bytes. Verification re-derives the
