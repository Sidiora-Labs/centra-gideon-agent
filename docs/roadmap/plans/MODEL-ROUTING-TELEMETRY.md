...
- **No new action provider** → no `ALLOWED_HOOK_PROVIDERS` (`src/gideon/validation.py`) change. (Rule restated per checklist: any future action provider must be added there or hook create/update rejects it.)
