...
- **(c) Per-task authorization, and it is the security control.** Copy Manus's control model, which is well-judged and maps cleanly onto Gideon's existing approval vocabulary:
