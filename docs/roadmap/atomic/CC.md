...
Decomposed CHAT-CRAFT (CC) into 8 atoms: 3 done (S1-S3, shipped as one feature-chat-craft commit 2026-07-27) and 5 todo (S4 screen-snip, optimizer polish, S4 polish/docs/validation wrap-up, Branch mechanic, chat plan-mode entry). No blocking cross-plan edges; one intra-plan edge (wrap-up needs all seven surfaces).
