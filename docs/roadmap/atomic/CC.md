...
Decomposed CHAT-CRAFT (CC) into 8 atoms: 4 done (S1-S3, shipped as one feature-chat-craft commit 2026-07-27; S4's screen-snip 2026-08-16) and 4 todo (optimizer polish, S4 polish/docs/validation wrap-up, Branch mechanic, chat plan-mode entry). No blocking cross-plan edges; one intra-plan edge (wrap-up needs all seven surfaces).
