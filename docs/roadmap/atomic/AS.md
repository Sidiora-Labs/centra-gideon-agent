...
9 atoms: 7 done, 2 todo. AS-1 (composable home / dashboard-as-views) is the spine most others build on. AS-3, AS-4, AS-7 are independent. AS-6 gated on AUTOMATION-SUBSTRATE; AS-8 gated on INBOX-NOTIFICATIONS-UNIFICATION S1-2.
