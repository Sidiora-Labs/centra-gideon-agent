...
localStorage → context → Suspense): nothing mounts under `gideon`, `gideon-arcade`, no stored
...
proofs now exercise every key in the closed block between them** — gideon-arcade: amber, sparkle
