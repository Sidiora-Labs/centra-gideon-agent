...
|---|---|---|
| `ChannelTransportProvider` | ABC — your class subclasses it | `from gideon.sdk.channel import ChannelTransportProvider` |
| `ChannelDelivery` | `Protocol` — structural, you do not subclass it | `from gideon.sdk.channel import ChannelDelivery` |
...
`gideon.sdk.channel`. That facade is the boundary the apps-repo import lint enforces
