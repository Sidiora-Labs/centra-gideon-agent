...
//
// Usage:
//   GIDEON_URL=http://localhost:10000 GIDEON_TOKEN=... node docs/screenshots/capture.mjs
//
...
const BASE = process.env.GIDEON_URL || 'http://localhost:10000';
const TOKEN = process.env.GIDEON_TOKEN || '';
