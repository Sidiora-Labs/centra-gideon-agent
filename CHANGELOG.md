...
- **Personalities: themes that carry an identity, not just a palette.** Settings → Design
  ...
  a terse operator voice, and **Claw Arcade**), alongside the default Gideon identity.
