...
from gideon.acp.dialect import DefaultDialect  # noqa: E402
from gideon.acp.session import AcpSession  # noqa: E402
from gideon.acp.types import JsonRpcMessage  # noqa: E402
...
def test_only_a_declaring_dialect_builds_a_mid_turn_frame():
    ...
    from gideon.acp.types import METHOD_PROMPT
...
async def test_the_per_turn_cap_bounds_deliveries_and_keeps_the_remainder_visible():
    ...
    from gideon.acp.session import _MAX_STEERS_PER_TURN
...
def test_the_acp_cap_matches_the_native_cap():
    ...
    from gideon.acp.session import _MAX_STEERS_PER_TURN as acp_cap
    from gideon.agents.native.runtime import _MAX_STEERS_PER_TURN as native_cap
...
async def test_the_client_rearms_the_seam_on_the_session_that_runs_the_turn(monkeypatch):
    ...
    from gideon.acp.types import EVENT_COMPLETE, AcpEvent, AcpPromptStats
