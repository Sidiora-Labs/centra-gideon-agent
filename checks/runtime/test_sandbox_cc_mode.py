...
class TestCcFilesList:
    ...
    def test_has_gideon_env(self):
        assert ".gideon/.env" in _CC_FILES
...
class TestAgentDeniedEnvKeys:
    ...
    def test_default_set_includes_slack_tokens(self):
        ...
        assert "GIDEON_OWNER_ID" in _AGENT_DENIED_ENV_KEYS
