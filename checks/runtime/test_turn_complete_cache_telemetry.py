...
_NO_CACHE_LINE = "Turn complete: 3 events, 1 tool calls, context 42% · $0.0123 · 1,200 in / 340 out tokens"
...
class TestHitPctHonesty:
    def test_unmeasured_states_no_percentage(self):
        line = _line(
            cache_read_tokens=12400, cache_creation_tokens=1200, cache_hit_pct=None
        )
...
class TestSavedUsdHonesty:
    def test_unpriced_model_says_unpriced_not_zero(self):
        line = _line(
            cache_read_tokens=12400, cache_creation_tokens=1200, cache_saved_usd=None
        )
    ...
    def test_measured_zero_saving_is_money_not_unpriced(self):
        line = _line(
            cache_read_tokens=12400, cache_creation_tokens=1200, cache_saved_usd=0.0
        )
