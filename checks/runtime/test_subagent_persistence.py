...
class TestTombstoneOnAbnormalExit:
    ...
    async def test_tombstone_on_timeout(self, agent_root):
        ...
        from gideon.subagent_persistence import create_agent_folder
    ...
    async def test_timeout_skipped_when_already_reaped(self, agent_root):
        ...
        from gideon.subagent import SubagentInfo, SubagentManager
        from gideon.subagent_persistence import create_agent_folder, write_tombstone
    ...
    async def test_tombstone_on_turn_limit(self, agent_root):
        ...
        from gideon.hooks import TOOL_AUTO_APPROVE, ToolHookResult
        from gideon.llm.base import EVENT_PERMISSION_REQUEST, LLMEvent
        from gideon.subagent import SubagentManager
...
class TestOrphanReconciliation:
    ...
    async def test_dead_pid_with_result_tombstoned_as_delivered(self, agent_root):
        ...
        from gideon.subagent import SubagentManager
        from gideon.subagent_persistence import create_agent_folder, write_result_chunk
    ...
    async def test_dead_pid_no_result_tombstoned_as_notified(self, agent_root):
        ...
        from gideon.subagent import SubagentManager
        from gideon.subagent_persistence import create_agent_folder, update_state
...
class TestSpawnStatusReadsFromAgentFolder:
    ...
    async def test_api_spawn_status_fallback_to_disk(self, agent_root):
        ...
        from gideon.dashboard.handlers.messaging import api_spawn_status
        from gideon.subagent_persistence import (
            create_agent_folder,
            write_result_chunk,
            write_tombstone,
...
class TestPathTraversal:
    def test_dot_agent_id_rejected(self, agent_root):
        from gideon.subagent_persistence import _agent_dir
