...
async def main():
    ...
    works.authors.create({"request_id": "writer", "title": "Pinned writer", "voice": {"tone": "Quiet"}})
    works.universes.create({"request_id": "world", "title": "Pinned world", "canon": [{"id": "law", "title": "Night"}]})
