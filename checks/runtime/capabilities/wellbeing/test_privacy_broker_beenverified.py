...
def setup(tmp_path, smtp):
    ...
    return (
        ...
        account,
        case,
        BeenVerifiedCaseAdapter(store, communications, outbound),
    )
...
def prepare(service, account, case, request="prepare"):
    return service.prepare(
        case["id"],
        {
            ...
            "profile_url": "https://www.beenverified.com/name/Jane-Doe/Oakland-CA/abc",
            "jurisdiction": "US-CA",
        },
    )
...
def test_prepare_creates_exact_canonical_draft_without_network_and_binds_case(
    ...
    assert (
        ...
        and "https://www.beenverified.com/name/Jane-Doe/Oakland-CA/abc" in draft["body"]
    )
...
def test_account_identity_profile_and_case_provider_fail_closed_before_email(
    ...
    for changes, match in [
        ...
        ({"profile_url": "https://attacker.example/jane"}, "BeenVerified listing"),
    ]:
        payload = {
