...
def test_native_manifest_resolves_real_tool_provider(isolated_home):
    ...
    reads |= {'people_stacker_territories', 'people_stacker_actions', 'people_x_snapshot', 'people_x_drafts', 'people_social_accounts', 'people_social_get', 'people_social_history'}
    writes |= {'people_stacker_read', 'people_stacker_prepare', 'people_stacker_review', 'people_stacker_submit', 'people_stacker_reconcile', 'people_x_sync', 'people_x_draft_create', 'people_x_draft_update', 'people_x_review', 'people_social_create', 'people_social_update', 'people_social_remove'}
