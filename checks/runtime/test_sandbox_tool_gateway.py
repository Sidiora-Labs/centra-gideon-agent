...
from gideon.sandbox_providers.gideon_tool import (
    DEFAULT_REQUEST_FD,
    DEFAULT_RESPONSE_FD,
    ENV_OFFERED,
    SHIM_SOURCE,
...
def test_the_shims_environment_carries_no_credential_material() -> None:
    ...
    assert set(env) == {"GIDEON_TOOL_REQUEST_FD", "GIDEON_TOOL_RESPONSE_FD", ENV_OFFERED}
...
def test_gideon_tool_reports_the_hosts_refusal_verbatim(home: Path, tmp_path: Path) -> None:
