...
def mcp_env(tmp_path: Path):
    ...
    with patch("gideon.dashboard.handlers.mcp._GLOBAL_MCP_JSON", mcp_json), \
         patch("gideon.dashboard.handlers.agents._installed_agent_config", return_value=agent_cfg):
