...
def test_plan_memory_roundtrip(tmp_path):
    from gideon.context_management import append_plan_event, load_plan_memory
...
def test_plan_memory_empty_session(tmp_path):
    from gideon.context_management import summarize_plan_memory_for_context
    import gideon.context_management as _cm
...
def test_build_stage_context(tmp_path):
    from gideon.context_management import build_stage_context, plan_lessons_path
...
def test_looks_like_plan_true():
    from gideon.context_management import looks_like_plan
...
async def test_rephrase_plan_not_a_plan_returns_none():
    ...
    from gideon.context_management import rephrase_plan

    client = AsyncMock()
    client.send_message = AsyncMock(return_value=None)

    with patch("gideon.llm_helpers.stream_and_collect", new_callable=AsyncMock) as mock_stream:
...
def test_validate_plan_format_valid():
    from gideon.context_management import validate_plan_format
...
def test_strip_plan_markers():
    from gideon.context_management import strip_plan_markers
