...
@patch("gideon.security.sandbox.platform.mac_ver", return_value=_MAC_VER_26_PLUS)
@patch("gideon.security.sandbox.sys")
...
@patch("gideon.security.sandbox.platform.mac_ver", return_value=_MAC_VER_BELOW_26)
@patch("gideon.security.sandbox.sys")
...
def test_subprocess_exception_returns_false(
    mock_run, mock_which, mock_sys, mock_mac_ver
):
    mock_sys.platform = "darwin"
    assert _probe_sandbox_exec() is False
